...
`;
  ...
  if (savingsPercentage > 20) {
    ...
    const savingsTip = document.getElementById("savings-tips");
    savingsTip.innerText = `You should be saving and investing 20% or more of your income. Your savings and investments payments total is £${totalSavingsSpend} and is ${savingsPercentage}% of your income. You should be saving more of your income.`;
    const savingsBox = document.querySelector("#savings-box");
...
//adding counter for number of visitors
